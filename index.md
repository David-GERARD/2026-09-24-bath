...
# Required variables
venue: "SAMBa CDT at the Univeristy of Bath"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Wolfson lecture theatre, 4W 1.7 on level 1, 4 West University of Bath, Claverton Down, Bath, BA2 7AY, United Kingdom"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "51.37957"     # decimal latitude of workshop venue - this should be a number greater than or equal to -90, and less than or equal to 90 (use https://www.latlong.net/)
longitude: "-2.32931"    # decimal longitude of the workshop venue - this should be a number greater than or equal to -180, and less than or equal to 180 (use https://www.latlong.net)
humandate: "Sep 24-25, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:30am - 4:30pm BST (8:30am - 3:30pm UTC)"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["David Forber", "David Gerard"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Lou Adkin"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["la642@bath.ac.uk"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
# Optional variables
